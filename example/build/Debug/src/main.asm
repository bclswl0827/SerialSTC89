...
;------------------------------------------------------------
	G$SerialBegin$0$0 ==.
	C$ttl.c$8$0_0$17 ==.
;	src/components/ttl.c:8: void SerialBegin(uint16_t b) {
;	-----------------------------------------
...
;------------------------------------------------------------
	...
	C$ttl.c$28$1_0$20 ==.
;	src/components/ttl.c:28: void SerialSetTimeout(uint16_t t) {
;	-----------------------------------------
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$51duino.h$14$1_0$54 ==.
;	inc/51duino.h:14: void main() {
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$51duino.h$16$1_0$54 ==.
;	inc/51duino.h:16: P0 = P1 = P2 = P3 = 0;
	mov	_P3,#0x00
	mov	_P2,#0x00
	mov	_P1,#0x00
	mov	_P0,#0x00
	C$51duino.h$18$1_0$54 ==.
...
;	assignBit
	mov	c,_P31
	mov	_P30,c
	C$51duino.h$20$1_0$54 ==.
;	inc/51duino.h:20: setup();
	lcall	_setup
00102$:
	C$51duino.h$23$3_0$56 ==.
;	inc/51duino.h:23: loop();
	lcall	_loop
	sjmp	00102$
	C$51duino.h$25$2_0$54 ==.
;	inc/51duino.h:25: }
	C$51duino.h$25$2_0$54 ==.
	XG$main$0$0 ==.
	ret
