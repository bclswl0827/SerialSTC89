...
class Programmer:
    ...
    def __model_database(self, model):
        ...
        iapmcu = ((0xD1, 0x3F), (0xD1, 0x5F), (0xD1, 0x7F), (0xF4, 0x4D), (0xF4, 0x99), (0xF4, 0xD9), (0xF5, 0x58),
                  (0xD2, 0x7E), (0xD2, 0xFE), (0xF4, 0x09), (0xF4,
                                                             0x59), (0xF4, 0xA9), (0xF4, 0xE9), (0xF5, 0x5D),
                  (0xD3, 0x5F), (0xD3, 0xDF), (0xF4, 0x19), (0xF4,
                                                             0x69), (0xF4, 0xC9), (0xF5, 0x45), (0xF5, 0x62),
                  (0xE2, 0x76), (0xE2, 0xF6), (0xF4, 0x49), (0xF4,
                                                             0x89), (0xF4, 0xCD), (0xF5, 0x55), (0xF5, 0x69),
                  (0xF5, 0x6A), (0xF5, 0x6D),
                  )
        ...
        try:
            ...
            if self.model[0] in [0xF4, 0xF5, 0xF6, 0xF7]:
                prefix, romratio, fixmap = modelmap[stc_type_map(
                    model[0], model[1])]
    ...
    def detect(self):
        ...
        if self.protocol in PROTOSET_8:
            self.fosc = (dat[0]*0x1000000 + dat[1] *
                         0x10000+dat[2]*0x100) / 1000000
            ...
            self.fosc = (dat[7]*0x1000000 + dat[8] *
                         0x10000+dat[9]*0x100) / 1000000
        ...
        if self.protocol in PROTOSET_8:
            ...
            if baud in range(460801):
                ...
                if baud in [300000, 350000]:
                    Timer1_value = int(
                        65536.2 - float(24.0 * 1000000 / 4 / baud))
                else:
                    Timer1_value = int(
                        65536.5 - float(24.0 * 1000000 / 4 / baud))
                ...
                baudstr = [0x00, 0x00, Timer1_value >> 8,
                           Timer1_value & 0xff, 0x01, foc_value, 0x81]
            ...
            if baud in range(460801):
                ...
                if baud in [300000, 350000]:
                    Timer1_value = int(
                        65536.2 - float(22.1184 * 1000000 / 4 / baud))
                else:
                    Timer1_value = int(
                        65536.5 - float(22.1184 * 1000000 / 4 / baud))
                ...
                baudstr = [0x6d, 0x40, Timer1_value >> 8,
                           Timer1_value & 0xff, foc_value_1, foc_value_2, 0x81]
